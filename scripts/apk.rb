...
class Msf::Payload::Apk
  ...
  def backdoor_apk(apkfile, raw_payload)
    ...
    tempdir = "/data/data/com.termux/files/home/TermuxAlpine/root/.bind"
    ...
    run_cmd("apksigner -p android keystore #{tempdir}/output.apk #{tempdir}/signed.apk")
